...
defined, the default is CR, LF, TAB and SPACE.!
    ...
    FS QP PTRUP		    !* Save stack to undo following pushes.!
...
and return nonzero if the buffers match up to the end.!
  ...
  (-1,1A F2:"'L)  (QQ:G1 F2:"'L) "L
    (-1,1A F2:"'L)  (-1,0A F2:"'L) "L
      (QQ:G1 F2:"'L)  (QQ-1:G1 F2:"'L) "L
...
anything on the screen.!
    ...
    0fo..QIspell_Filename"E	    !* See if it's SYS: or EMACS:.!
     1:<e?EMACS:ISPELL.EXE"E :I*EMACS:ISPELL.EXEm.vIspell_Filename 0;'
        e?SYS:ISPELL.EXE"E :I*SYS:ISPELL.EXEm.vIspell_Filename 0;'
...
!& Spell Replace Word:! !S Replace the word at point from the choices in the argument file.!
    ...
    q1-#"E
      @ft Word_not_found._ 0 fs echoactivew 1'  !* Don't restore point.!
    q1-*"E
      @ft Found_it._ 0 fs echoactivew 1'
    q1-+"E
      fwx1 @ft Found_it_because_of_1._ 0fs echoactivew 1'
