!* [toed.xkl.com]DXX:<EMACS>LONG-FILENAMES.EMACS.128,  5-Apr-96 18:21:17, Edit by ALDERSON!
...
from source.!
 ...
 m(m.mGenerate Library)1.ELIB.20	!* Pass specific version!
						!* ..numbers to Generate.!

...
Returns the single matching filename (string) or else the number of
 ...
 q1"e				    !* Must create it from default.!
    fsOSTeco-1"e		    !* TWENEX.!
      :i1.COM..:EJ..ELIB..EXE..PROFILE..SAV..REL..MODES..OBJ..BIN.
