...
In-reply-to:"l j '			!* User already put in an in-reply-to.!
   fqMessage-ID:"g			!* Was there a Message-ID!
      zj iIn-Reply-To: 		!* Yeah, use it!
      gMessage-ID: w-2 f=
"ni
''					!* In which case thats all we do.!
					!* Otherwise, old style!
...
					!* Boundary condition for search.!
 ...
 qBabyl Strip Local Host"n fsMachine:f6u7	!* 7: Local host.!
    ...
    "# 
      :i* at 7fo..q Babyl Horribly Kludge Local Hostu7''
					!* 7: hostname or local kludges!
